        ...
        <div class="detail-model-container">
            ...
            <div class="offer-info">
                <ul class="offer-info-list">
                    ...
                    <li>Valid Till: <span>{{ new Date(props.validUntil).toLocaleDateString("en-US", {
                            weekday:
                                'long', year: 'numeric', month: 'long', day: 'numeric'
                        })
                    }}</span></li>
                    <li>Description: <br> <span>{{ props.description }}</span></li>
                    <li>T & C: <br> <span>{{ props.t_and_c }}</span></li>
                </ul>
            </div>
        </div>
    </ion-content>
...
const props = defineProps(["TagLine", "offerImage", "offerType", "validUntil", "description", "t_and_c"])
